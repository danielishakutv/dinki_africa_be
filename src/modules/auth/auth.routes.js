...
const resendLimiter = createLimiter(4, 15);      // 4 verification resends per 15 min
...
router.post('/verify-email', validate(verifyEmailTokenSchema), ctrl.verifyEmail);
router.post('/resend-verification', auth, resendLimiter, ctrl.resendVerification);
